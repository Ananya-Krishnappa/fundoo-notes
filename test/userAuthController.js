...
describe('User Authentication', function () {
  describe('User Registration', function () {
    ...
    it('givenEmailAndPasswordInReqBody_whenInvokedLoginFunc_thenReturnUserLoggedInSuccessfully', function () {
      ...
      let token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjoid2Fyb2sxMkBnbWFpbC5jb20iLCJleHBpcmVzSW4iOiIxaCIsImlhdCI6MTYyNzkzMDg0OX0.3FK4Cc3ncleCcqAaR-sthQzJtAZ1XeFcrfkaPXldQVk";
